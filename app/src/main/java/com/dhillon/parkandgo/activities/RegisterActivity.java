...
//create variables
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_register);//links register java page to xml register page
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.appCompatButtonRegister:
                postDataToSQLite();//Posts data to database
                break;

            case R.id.appCompatTextViewLoginLink:
                finish();// redirects user to login page
                break;
        }
    }
