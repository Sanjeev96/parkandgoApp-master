...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     // This method is to initialize views(what user sees)
    ...
    private void initViews() {
     ...
     //This method is to initialize listeners(such as button clicks)
   ...
   //objects to be used
    ...
    //Used to empty Email and Password fields if error message is displayed due to user error
