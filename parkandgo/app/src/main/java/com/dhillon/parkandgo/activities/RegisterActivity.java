...
public class RegisterActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private AppCompatTextView TxtViewLoginLink;
    ...
    private void initViews() {
        ...
        TxtViewLoginLink = (AppCompatTextView) findViewById(R.id.TxtViewLoginLink);
    ...
    private void initListeners() {
        ...
        TxtViewLoginLink.setOnClickListener(this);
